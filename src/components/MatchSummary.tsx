...
export const MatchSummary = ({
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white font-sans flex items-center justify-center p-4">
      <Card ref={summaryRef} className="w-full max-w-2xl bg-[#222] border-none shadow-2xl overflow-hidden">
        {/* Header Section */}
        <div className="bg-[#2a2a2a] p-6 border-b border-gray-800">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm font-medium text-white px-3 py-1 bg-white/5 rounded-full whitespace-nowrap">
        ...
        <CardContent className="p-0">
          {/* Innings 1 Details */}
          <div className="p-4">
            <div className="bg-[#2a2a2a] py-2 px-6 flex items-center justify-center gap-2 border-b border-gray-800 mb-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                {i1Performers.batters.map((batter: any) => (
                  <div key={batter.name} className="flex items-center gap-3 bg-white/5 p-2.5 rounded-lg border border-white/5">
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold text-sm text-white capitalize leading-tight">{batter.name}</span>
                      <span className="text-orange-400 text-sm font-mono font-bold leading-tight">
                        {batter.runs} <span className="text-xs text-gray-500 font-sans">({batter.balls})</span>
                      </span>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-4">
                {i1Performers.bowlers.map((bowler: any) => (
                  <div key={bowler.name} className="flex items-center justify-end gap-3 text-right bg-white/5 p-2.5 rounded-lg border border-white/5">
                    <div className="flex flex-col items-end">
                      <span className="font-bold text-sm text-white capitalize leading-tight">{bowler.name}</span>
                      <span className="text-blue-400 text-sm font-mono font-bold leading-tight">
                        {bowler.wickets}/{bowler.runs} <span className="text-xs text-gray-500 font-sans">({getBowlerOvers(bowler.balls)})</span>
                      </span>
                    </div>
                    <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center overflow-hidden flex-shrink-0">
                      <User className="w-6 h-6 text-gray-400" />
          ...
          {innings2.team && (
            <>
              <div className="bg-[#2a2a2a] py-2 px-6 flex items-center justify-center gap-2 border-y border-gray-800">
          ...
          {/* Footer Actions */}
          <div className="p-4 bg-[#2a2a2a] border-t border-gray-800 flex justify-center gap-4">
            <Button
